...
abstract class FileTemplater {
  ...
  /** Returns a setting key, that when evaluated will do nothing if [[enabledFlag]] is `false`, otherwise:
    ...
    * </ul>
    */
  def generateSettings(implicit ctx: PluginContext): Def.Setting[Unit] =
  ...
  private def buildHeader(prefix: String = "#")(implicit ctx: PluginContext): String =
    s"""$prefix ------------------ autogenerated file - do not edit -------------------
       |$prefix           This file was generated by ${ctx.pluginName}
       |$prefix
